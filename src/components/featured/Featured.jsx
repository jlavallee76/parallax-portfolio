        ...
        <section id="featured" className="featured">
            <div className="left">
                <div className="inner transition2">
                    ...
                    <a target="_blank" rel="noreferrer" href="https://github.com/jlavallee76/Water-Assessment-Project" className="featured-title">Water Assessment Project</a>
            ...
            <img className="right transition2" src="../assets/projects/wap.png" alt="placeholder" />
        </section>
    )
}
